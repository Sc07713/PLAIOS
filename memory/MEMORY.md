...
- [Trading V3 decomposed — V3.1 done, V3.2/V3.3 next](project_trading_v3_scope_pending.md) — V3.1 robustness layer shipped 2026-05-11 (costs/OOS/PSR/DSR/verdict-report); V3.2 portfolio overlay next; V3.3 fundamentals via SEC EDGAR companyfacts + Finnhub
