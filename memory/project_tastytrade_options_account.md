...
**Current real positions (2026-05-12, context — not modeled by trading-tools yet):** tastytrade options on **AGI** (Alamos Gold, a gold miner) and **SLV** (iShares Silver Trust); plus **physical silver** held outright (price-tracked against XAGUSD spot). Precious-metals tilt across the book — consistent with the "hold gold when in doubt / gold is the hurdle" stance in [[user_investment_philosophy]] (silver = the higher-beta cousin). The V3.2 equity overlay's gold residual sleeve is GLD; physical silver and the metals-miner options live entirely outside trading-tools (V4+ territory).
